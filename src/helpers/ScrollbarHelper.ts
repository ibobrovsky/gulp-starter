interface ScrollbarHelperProps {
  classFixed?: string
}
...
export class ScrollbarHelper {
  ...
  constructor(protected params?: ScrollbarHelperProps) {
  ...
  checkScrollbar(): void {
    ...
    this.scrollbarWidth = ScrollbarHelper.getScrollbarWidth()
  }
  ...
  remove(el?: HTMLElement | null, timeout: number = 0) {
    setTimeout(() => {
      ScrollbarHelper.resetAdjustments(el)
      if (this.count === 1) {
...
export const scrollbar = new ScrollbarHelper({
